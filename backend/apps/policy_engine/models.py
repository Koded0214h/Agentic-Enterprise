...
# NOTE: Workspace lives in apps.agent_gateway.models.Workspace — single source of truth.
# Policy.workspace below references it by string to avoid a circular import at app-load time.
